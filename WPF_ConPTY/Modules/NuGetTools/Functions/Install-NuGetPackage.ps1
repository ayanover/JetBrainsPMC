function Install-NuGetPackage {
    ...
    .EXAMPLE
    Install-NuGetPackagePackage -PackageId "Newtonsoft.Json"
    
    .EXAMPLE
    Install-NuGetPackage -PackageId "Microsoft.EntityFrameworkCore" -Version "5.0.0"
    
    .EXAMPLE
    Install-NuGetPackagePackage -PackageId "Microsoft.AspNetCore.Mvc" -PreRelease
    #>
    [CmdletBinding()]
    param (
    ...
    process {
        try {
            ...
            $projectFiles = Get-ChildItem -Path . -Include "*.csproj", "*.fsproj", "*.vbproj" -File -Recurse
